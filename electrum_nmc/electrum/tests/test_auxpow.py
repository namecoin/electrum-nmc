...
namecoin_prev_hash_19414 = (
    "8b979e3b34faa5ab90a44dcc9a7ab9618640d5d1eec3e8239108c85c6bf80061"
)
...
namecoin_prev_hash_37174 = (
    "8adc6de6bd46c73aa631a72b29e21e84e49a06ce99002a77dce0b5aca4bf81d6"
)
...
prev_hash_zero_output_auxpow = (
    "ac43bc7ff15104962ccaff40bd768345559009cb7fb80cae7330c9bd86f47e91"
)
...
class Test_auxpow(SequentialTestCase):
    ...
    def deserialize_with_auxpow(data_hex: str, **kwargs):
        ...
        return blockchain.deserialize_full_header(
            bfh(data_hex), constants.net.max_checkpoint() + 1, **kwargs
        )
    ...
    def clear_coinbase_outputs(auxpow_header: dict, fix_merkle_root=True) -> None:
        ...
        auxpow_header["parent_coinbase_tx"]._cached_network_ser_bytes = bfh(
            auxpow_header["parent_coinbase_tx"].serialize_to_network(force_legacy=True)
        )
    ...
    def test_deserialize_auxpow_header_explicit_coinbase(self):
        ...
        expected_coinbase_txid = (
            "8a3164be45a621f85318647d425fe9f45837b8e42ec4fdd902d7f64daf61ff4a"
        )
        ...
        self.assertEqual(
            header_auxpow["coinbase_merkle_branch"],
            [
        ...
        self.assertEqual(
            header_auxpow["chain_merkle_branch"],
            [
        ...
        expected_parent_header = blockchain.deserialize_pure_header(
            bfh(
                "0100000055a7bc918827dbe7d8027781d803f4b418589b7b9fc03e718a03000000000000625a3d6dc4dfb0ab25f450cd202ff3bdb074f2edde1ddb4af5217e10c9dbafb9639a0a4fd7690d1a25aeaa97"
            ),
            None,
        )
    ...
    def test_deserialize_with_expected_trailing_data(self):
        ...
        _, start_position = self.deserialize_with_auxpow(
            data, expect_trailing_data=True, start_position=1
        )
    ...
    def test_verify_auxpow_header_explicit_coinbase(self):
        header = self.deserialize_with_auxpow(namecoin_header_37174)
        blockchain.Blockchain.verify_header(
            header, namecoin_prev_hash_37174, namecoin_target_37174
        )
    ...
    def test_verify_auxpow_header_implicit_coinbase(self):
        ...
        blockchain.Blockchain.verify_header(
            header, namecoin_prev_hash_19414, namecoin_target_19414
        )
    ...
    def test_verify_auxpow_header_zero_output_coinbase(self):
        ...
        blockchain.Blockchain.verify_header(
            header, prev_hash_zero_output_auxpow, target_zero_output_auxpow
        )
...
def update_merkle_root_to_match_coinbase(auxpow_header):
    ...
    revised_merkle_root = hash_merkle_root(
        revised_merkle_branch,
        revised_coinbase_txid,
