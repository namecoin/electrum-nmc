...
MSG_HW_STORAGE_ENCRYPTION = (
    _("Set wallet file encryption.") + "\n" + _("Your wallet file does not contain secrets, mostly just metadata. ") + _(
...
WIF_HELP_TEXT = (
    _("WIF keys are typed in Electrum-NMC, based on script type.") + "\n\n" + _("A few examples") + ":\n" + "p2pkh:TktYN7Gf6FfF...       \t-> N4S65fkQe...\n" + _(
...
MSG_PASSPHRASE_WARN_ISSUE4566 = (
    ...
    ) + " " + _("This is discouraged.") + " " + _(
        "Due to a bug, old versions of Electrum-NMC will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def init_network(self, network: "Network"):
        message = _(
            "Electrum-NMC communicates with remote servers to get "
