# Electrum-NMC AppArmor Profiles
...
```
Look for the entry corresponding to `electrum-nmc`

## Usage 
After installing the AppArmor profile, electrum-nmc will be restricted to the permissions specified in the profile.
